...
val SlateLight = IrisColorScheme(
    primary              = Color(0xFF7A6650),
    onPrimary            = Color(0xFFFFFFFF),
    primaryContainer     = Color(0xFFF0E6DB),
    onPrimaryContainer   = Color(0xFF2E1F12),
    gradientEnd          = Color(0xFF9C846E),
    onGradientEnd        = Color(0xFFFFFFFF),
    secondary            = Color(0xFF695E54),
    onSecondary          = Color(0xFFFFFFFF),
    secondaryContainer   = Color(0xFFEDE3D8),
    onSecondaryContainer = Color(0xFF463C34),
...
val RoseQuartzLight = IrisColorScheme(
    primary              = Color(0xFF8D4E70),
    onPrimary            = Color(0xFFFFFFFF),
    primaryContainer     = Color(0xFFFDE7F2),
    onPrimaryContainer   = Color(0xFF4B1F3A),
    gradientEnd          = Color(0xFFC17696),
    onGradientEnd        = Color(0xFFFFFFFF),
    secondary            = Color(0xFF6B5B62),
    onSecondary          = Color(0xFFFFFFFF),
    secondaryContainer   = Color(0xFFEFE2E8),
    onSecondaryContainer = Color(0xFF493B42),
    surface              = Color(0xFFFCF9FA),
    onSurface            = Color(0xFF1C181A),
    surfaceVariant       = Color(0xFFF1EBEE),
    onSurfaceVariant     = Color(0xFF534A4E),
    background           = Color(0xFFF6F2F4),
    onBackground         = Color(0xFF1C181A),
    isDark               = false,
)
...
val SageLight = IrisColorScheme(
    primary              = Color(0xFF3D7E5C),
    onPrimary            = Color(0xFFFFFFFF),
    primaryContainer     = Color(0xFFE0F5E9),
    onPrimaryContainer   = Color(0xFF12361F),
    gradientEnd          = Color(0xFF569C71),
    onGradientEnd        = Color(0xFFFFFFFF),
    secondary            = Color(0xFF536352),
    onSecondary          = Color(0xFFFFFFFF),
    secondaryContainer   = Color(0xFFDEE7DC),
    onSecondaryContainer = Color(0xFF334232),
    surface              = Color(0xFFFCFDFB),
    onSurface            = Color(0xFF171B17),
    surfaceVariant       = Color(0xFFEEF4ED),
    onSurfaceVariant     = Color(0xFF4C544B),
...
val CobaltLight = IrisColorScheme(
    primary              = Color(0xFF2E5A9E),
    onPrimary            = Color(0xFFFFFFFF),
    primaryContainer     = Color(0xFFDCE8FF),
    onPrimaryContainer   = Color(0xFF002158),
    gradientEnd          = Color(0xFF4F7EC8),
    onGradientEnd        = Color(0xFFFFFFFF),
    secondary            = Color(0xFF535E72),
    onSecondary          = Color(0xFFFFFFFF),
    secondaryContainer   = Color(0xFFDCE3F0),
    onSecondaryContainer = Color(0xFF353F52),
    surface              = Color(0xFFFCFDFF),
    onSurface            = Color(0xFF181C26),
    surfaceVariant       = Color(0xFFEEEFF5),
    onSurfaceVariant     = Color(0xFF484F5E),
...
val EmberLight = IrisColorScheme(
    primary              = Color(0xFFB0681A),
    onPrimary            = Color(0xFFFFFFFF),
    primaryContainer     = Color(0xFFFFEDCF),
    onPrimaryContainer   = Color(0xFF4F2700),
    gradientEnd          = Color(0xFFCE8337),
    onGradientEnd        = Color(0xFFFFFFFF),
    secondary            = Color(0xFF78614A),
    onSecondary          = Color(0xFFFFFFFF),
    secondaryContainer   = Color(0xFFF0E3D2),
    onSecondaryContainer = Color(0xFF4D3C2C),
    surface              = Color(0xFFFDFAF6),
    onSurface            = Color(0xFF1F1B16),
    surfaceVariant       = Color(0xFFF1ECE3),
    onSurfaceVariant     = Color(0xFF5C5247),
...
val MonochromeLight = IrisColorScheme(
    ...
    onSurfaceVariant     = Color(0xFF58585C),
